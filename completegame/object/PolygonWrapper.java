...
public class PolygonWrapper {
	...
	private Vector2f[] wrapNorth(Vector2f[] poly) {
		return transform(poly, Matrix3f.translate(0.0f, worldHeight));
	}
	...
	private Vector2f[] wrapEast( Vector2f[] poly ) {
		return transform( poly, Matrix3f.translate( worldWidth, 0.0f ) );
	}
	...
	private Vector2f[] wrapNorthWest( Vector2f[] poly ) {
		return transform(poly, Matrix3f.translate( -worldWidth, worldHeight ));
	}
