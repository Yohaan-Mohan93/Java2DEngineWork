...
public class MatrixMultiplyExample extends JFrame implements Runnable{
	...
	private void render(Graphics g) {
		...
		g.drawString("Press [SPACE] to toogle stars", 20, 35);
		...
		Matrix3f sunMat = Matrix3f.identity();
		sunMat = sunMat.mul(Matrix3f.translate(SCREEN_W / 2, SCREEN_H / 2));
		...
		Matrix3f earthMat = Matrix3f.translate(SCREEN_W / 4, 0);
		earthMat = earthMat.mul(Matrix3f.rotate(earthRot));
		...
		Matrix3f moonMat = Matrix3f.translate(30, 0);
		moonMat = moonMat.mul(Matrix3f.rotate(moonRot));
