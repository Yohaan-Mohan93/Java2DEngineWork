...
public class BlockingHardware {
	...
	private List<BlockingHardwareListener> listeners = Collections.synchronizedList(new ArrayList<BlockingHardwareListener>());
	...
	protected void handleHardwareEvent(FakeHardware source, FakeHardwareEvent event) {
